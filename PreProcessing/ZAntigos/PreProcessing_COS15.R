...
COS_A2007_A2005_BDALL_byFRE18 = left_join(COS2007_BDALL_byFRE18, COS2015_BDALL_byFRE18, by = c("DICOFRE18" = "DICOFRE18"))

colreplace = colnames(COS_A2007_A2005_BDALL_byFRE18)
...
colnames(COS_A2007_A2005_BDALL_byFRE18) = colreplace

#COS_A2007_A2005_BDALL_byFRE18[is.na(COS_A2007_A2005_BDALL_byFRE18)] = 0

OUT.VAR_COS07_COS15_FREG18 =  COS_A2007_A2005_BDALL_byFRE18 %>% 
  group_by( DICOFRE18 ) %>% 
  summarise(
    V_1_Change0715 = round( (V_1_COS15 - V_1_COS07) / V_1_COS07 ,2),
    V_2_Change0715 = round( (V_2_COS15 - V_2_COS07) / V_2_COS07 ,2),
    V_3_Change0715 = round( (V_3_COS15 - V_3_COS07) / V_3_COS07 ,2),
    V_11_Change0715 = round( (V_1_1_COS15 - V_1_1_COS07) / V_1_1_COS07 ,2),
    V_12_Change0715 = round( (V_1_2_COS15 - V_1_2_COS07) / V_1_2_COS07,2),
    V_13_Change0715 = round( (V_1_3_COS15 - V_1_3_COS07) / V_1_3_COS07,2),
    V_14_Change0715 = round( (V_1_4_COS15 - V_1_4_COS07) / V_1_4_COS07,2),
    V_111_Change0715 = round( (V_1_1_1_COS15 - V_1_1_1_COS07) / V_1_1_1_COS07,2),
    V_112_Change0715 = round( (V_1_1_2_COS15 - V_1_1_2_COS07) / V_1_1_2_COS07,2)
  )


COS_A2007_A2005_BDALL_byFRE18 = left_join(COS_A2007_A2005_BDALL_byFRE18, OUT.VAR_COS07_COS15_FREG18, by = c("DICOFRE18" = "DICOFRE18"))
