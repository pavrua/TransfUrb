...
POTDEMO2011byFREG2018 = data.frame(DICOFRE18 = colnames(POTDEMO2011byFREG2018_A), ACESS_ALL_byFREG2018 = as.numeric(t(ACESS_ALL_byFREG2018_A))  )
...
OUT.ACESS_ALL_byFREG2018 = POTDEMO2011byFREG2018
...
BD_TRANSFURB = left_join(BD_TRANSFURB, OUT.POPCENSOS_2001e2011, by = c("DICOFRE18" = "DICOFRE18"))
...
BD_TRANSFURB = left_join(BD_TRANSFURB, OUT.POP_PPF, by = c("DICOFRE18" = "DICOFRE18"))

BD_TRANSFURB$POP_VarPop_C2011C2015 = (BD_TRANSFURB$POP_PPF_2015_Total - BD_TRANSFURB$POP_C2011_Total) / BD_TRANSFURB$POP_C2011_Total

BD_TRANSFURB$DensPOP2011_TerritArtif = BD_TRANSFURB$POP_C2011_Total / BD_TRANSFURB$AREACategN1_T1

BD_TRANSFURB[is.na(BD_TRANSFURB)] = 0 


save(BD_TRANSFURB,
     file = "OUT.BD_TRANSFURB.RData" )
